...
namespace WonderGather.Tests
{
    public sealed class FactionPersistenceTests
    {
        ...
        [Test] public void UnsupportedIncompleteAndUnknownFilesAreLeftIntact()
        {
            ...
            foreach(var invalid in new[]{valid.Replace("\"version\": 4","\"version\": 99"),valid.Replace("\"start\": 8,",""),valid.Replace("{","{\"futureData\":42,"),"{ incomplete",valid.Replace("\"start\": 8","\"start\": -2")})
            {
